package com.jagungin.paginationlocal
...
import com.jagungin.paginationlocal.adapter.AdapterData
...
/*        recycler_view_data_activity_main.addOnScrollListener(object :
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (!isLoading && isLastPosition && countLoadMore < 3) {
                    ...
                    doAsync {
                        ...
                        repeat(10) { a ->
                            val lastValue: Int = when (a) {
                                0 -> listData[listData.size - 2].toInt()
                                else -> listData[listData.size - 1].toInt()
                            }
                            listData.add(lastValue.plus(1).toString())
                            listViewType.add(AdapterData.ITEM_VIEW_TYPE_CONTENT)
                        }
